...
namespace RecordStudioGamzaev.Controllers
{
    public class StudiosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PricePerHour")] Studio studio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PricePerHour")] Studio studio)
        {
            if (id != studio.Id)
            {
                return NotFound();
